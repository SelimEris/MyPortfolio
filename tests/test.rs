...
test!(conditional_greater_than, r#"5 > 3"#, Ok(Value::Bool(true)));
test!(conditional_equal_to, r#"4 == 4"#, Ok(Value::Bool(true)));
test!(conditional_not_equal_to, r#"5 != 3"#, Ok(Value::Bool(true)));
